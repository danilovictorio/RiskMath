...
```javascript
<template>
  <div class="w-screen h-screen flex items-center justify-center bg-center bg-cover bg-no-repeat"
    style="background-image: url('/mapaTauler.png');">
    <div class="container">
      <div class="turno-de">
      ...
      <div class="preguntas">
        <div v-if="app.getMostrarPreguntas()">
          ...
          <div class="respuestas" v-if="app.getMostrarPreguntas()">
            <button v-for="respuesta in app.pregunta.respuestas" :key="respuesta.id"
