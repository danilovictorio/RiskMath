    ...
    <div class="mapa">
      <svg version="1.1" id="svg47" sodipodi:docname="MAPA.SVG" inkscape:version="1.1.1 (3bf5ae0d25, 2021-09-20)"
        ...
        <path id="ES-AN" title="Andalusia" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-AN' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'))" />
        <path id="ES-AR" title="Arago" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-AR' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
        ...
        <path id="ES-AS" title="Asturies" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-AS' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-CB" title="Cantabria" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-CB' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-CL" title="Castella i Lleo" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-CL' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-CM" title="Castella-la Manxa" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-CM' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-CT" title="Catalunya" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-CT' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), $event.target.getAttribute('fill'), this.app.nombre)" />
        <path id="ES-EX" title="Extremadura" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-EX' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-GA" title="Galicia" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-GA' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-RI" title="La Rioja" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-RI' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-MD" title="Madrid" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-MD' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-MC" title="Murcia" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-MC' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-NC" title="Navarra" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-NC' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-PV" title="Pais Basc" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-PV' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
        <path id="ES-VC" title="Valencia" class="land"
          ...
          :fill="resultadoPregunta && paisSeleccionado == 'ES-VC' ? this.app.turnoDe.color : '#ffffff'" fill-opacity="1"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), this.app.nombre)" />
      </svg>
    </div>
