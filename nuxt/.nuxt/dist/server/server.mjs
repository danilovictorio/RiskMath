import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, isRef, isReactive, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, defineComponent, provide, createElementBlock, isShallow, Suspense, Transition, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/CrearSala-B_K9x8Dt.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index-CwGQ3zpj.js").then((m) => m.default || m)
  },
  {
    name: "PaginaFinalitzada",
    path: "/PaginaFinalitzada",
    meta: {},
    alias: [],
    redirect: __nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect,
    component: () => import("./_nuxt/PaginaFinalitzada-fhSpTp85.js").then((m) => m.default || m)
  },
  {
    name: "SalaEspera",
    path: "/SalaEspera",
    ...
    component: () => import("./_nuxt/SalaEspera-B95VgbRZ.js").then((m) => m.default || m)
  },
  {
    name: "TaulerView",
    path: "/TaulerView",
    ...
    component: () => import("./_nuxt/TaulerView-DM9YtD93.js").then((m) => m.default || m)
  },
  {
    name: "UnirseSala",
    path: "/UnirseSala",
    ...
    component: () => import("./_nuxt/UnirseSala-BwVL4sC_.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B8eiMCUg.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BxgLf4nY.js").then((r) => r.default || r));
