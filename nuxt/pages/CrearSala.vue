<template>
  <p class="text-center text-blue-700 mb-4">Aquí puedes crear una nueva sala para jugar con tus amigos. <br>Solo tienes que introducir el nombre de la sala y la capacidad máxima de jugadores.</p>
    ...
    <div class="w-full flex items-center justify-center bg-blue-200 p-8 sm:px-8 lg:px-8 rounded-lg">
      <div class="shadow-lg sm:rounded-lg rounded-lg bg-blue-300 p-6 rounded-lg">
        ...
        <form @submit.prevent="crearSala" class="space-y-4">
          <div>
            <label for="nombreSala" class="block text-sm font-medium text-blue-700">Nombre de la sala:</label>
          ...
          <div>
            <label for="capacidadSala" class="block text-sm font-medium text-blue-700">Capacidad de la sala:</label>
        ...
        <p v-if="link" class="text-center text-sm text-blue-700">Enlace de la sala: {{ link }}</p>
      </div>
    </div>
    <div class="mt-4">
