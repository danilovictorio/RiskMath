<template>
    <div>
      ...
      <button @click="crearPregunta()" class="mt-4 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Crear Pregunta</button>
      ...
      <div v-if="showModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75">
        <div class="bg-white p-8 rounded shadow-md">
          ...
          <input v-model="preguntaEditada.respuesta_correcta" class="border rounded p-2 mb-2" placeholder="Respuesta Correcta">
