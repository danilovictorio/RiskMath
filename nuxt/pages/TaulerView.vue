    ...
    <div class="mapa">
      <svg class="mapImage" version="1.1" id="svg47" sodipodi:docname="MAPA.SVG"
        ...
        <path id="ES-AN" title="Andalusia" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-AN' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
        ...
        <path id="ES-AR" title="Arago" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-AR' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-AS" title="Asturies" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-AS' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-CB" title="Cantabria" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-CB' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-CL" title="Castella i Lleo" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-CL' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-CM" title="Castella-la Manxa" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-CM' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-CT" title="Catalunya" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-CT' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
        ...
        <path id="ES-EX" title="Extremadura" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-EX' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-GA" title="Galicia" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-GA' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-RI" title="La Rioja" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-RI' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-MD" title="Madrid" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-MD' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-MC" title="Murcia" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-MC' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-NC" title="Navarra" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-NC' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-PV" title="Pais Basc" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-PV' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
        <path id="ES-VC" title="Valencia" class="land"
          ...
          :fill="resultadoPregunta && app.getPaisSeleccionado() == 'ES-VC' ? app.turnoDe.color : '#ffffff'" fill-opacity="1" stroke="#000000" stroke-width="0.5"
          @click="manejarClic($event.target.getAttribute('id'), $event.target.getAttribute('title'), app.nombre)" />
      </svg>
    </div>
